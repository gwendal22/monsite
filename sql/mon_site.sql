...
--
-- Hôte : localhost
-- Généré le :  lun. 05 nov. 2018 à 20:37
...
--
-- Structure de la table `chatmembers`
--
...
--
-- Déchargement des données de la table `chatmembers`
--

INSERT INTO `chatmembers` (`ID`, `Username`, `Message`) VALUES
(1, 'Jojo', 'lol'),
(2, 'User2', 'test2'),
...
--
-- Index pour la table `chatmembers`
--
...
--
-- AUTO_INCREMENT pour la table `chatmembers`
--
ALTER TABLE `chatmembers`
